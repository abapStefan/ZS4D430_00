...
@EndUserText.label: 'Abteilung (Abfrage)'
@Metadata.ignorePropagatedAnnotations: true
define view entity Z40_DEPARTMENTQUERY
  with parameters
  ...
  as select from Z40_C_EmployeeQueryP(p_target_curr: $parameters.p_target_curr,
                                               p_date:        $parameters.p_date ) as e
    right outer join  Z40_R_DEPARTMENT  as d 
