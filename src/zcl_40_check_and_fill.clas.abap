CLASS zcl_40_check_and_fill DEFINITION PUBLIC
 FINAL
 CREATE PUBLIC.
...
CLASS ZCL_40_CHECK_AND_FILL IMPLEMENTATION.
...
*
    CONSTANTS c_employ_table  TYPE tabname VALUE 'Z40EMPLOY'.
    CONSTANTS c_depment_table TYPE tabname VALUE 'Z40DEPMENT'.
